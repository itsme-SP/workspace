...
void SPI_Config(){
	...
	SPI_Send_data_config.spi_config.SPI_dev_md=SPI_DEV_MASTER;
...
//Enable the Gpio for spi
    ...
    //Spi peripheral config: SPE enabling,that is the 6tth bit of cr1 register m
	SPI_Peripheral_Config(SPI2,ENABLE);
