...
/*
 * bit position values of spi cr register these macros are used to store the pin number that we use in the spi_driver.c
 * we give the macros because it will be easier for us to decode if any errors occur and if someone else sees this code then easier for them to understand it
 */
...
/*
 * bit position values of spi sr register these macros are used to store the pin number that we use in the spi_driver.c
 * we give the macros because it will be easier for us to decode if any errors occur and if someone else sees this code then easier for them to understand it
 */
