...
#define GPIO_MODE_IT_FT  4 //GPIO MODE INPUT FALLING EDGETRIGGER
#define GPIO_MODE_IT_RT  5 ////GPIO MODE INPUT RISING EDGE TRIGGER
#define GPIO_MODE_IT_RFT 6 ////GPIO MODE INPUT RISING EDGE FALLING EDGE TRIGGER
...
void GPIO_IRQ_Priority_Config(uint8_t IRQNumber,uint32_t IRQPriority);//to set the priority of the interrupt
